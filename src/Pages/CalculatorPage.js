...
function CalculatorPage() {
  ...
  return (
    <div className="App">
      ...
      <form>   
            <input type="number" id="num" placeholder="Min" min="1" max="100"/>
