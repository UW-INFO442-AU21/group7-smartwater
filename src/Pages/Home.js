...
accessible in the US.</p>
            ...
            <p>On average, someone from America can use 82 gallons of water each day and 30 of them can be done unknowingly by them. If you are from America, chances are, you have contributed to little actions that waste water over time. While this is certainly not your fault, it is important that you try to make changes to your behavior for the sake of the environment. You can start by making small changes throughout your day that can help conserve water. While this may sound like there is no juice, it will make a big difference. If you, your friends, and family adopt healthy water saving habits, we will be able to reach our long-term goal of reducing water waste. Water is a vital part of our ecosystem and by conserving it, people are able to contribute to acts that will sustain food production and sanitation.</p>
            </div>
        </div>
    )
}